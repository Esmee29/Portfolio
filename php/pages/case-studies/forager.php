<section>
    <img src="Images/forager-app.webp" class="cover-img" alt="Parenting Pod app project">
    <div class="index-title">
        <h2 class="h1">Forager</h2>
    </div>
    <div class="case-grid">
        ...
        <div class="case-study">
            <img src="Images\Slide+16_9+-+1.jpg" class="case-img" alt="Supersonic app project">
        </div>
        <div class="case-study">
            <img src="Images\Screenshot 2024-07-08 114142.png" class="case-img" alt="Supersonic app project">
        </div>
