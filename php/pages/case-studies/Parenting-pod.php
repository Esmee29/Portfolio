<section>
    <img src="Images\baby.png" class="cover-img" alt="Forager app project">
    <div class="index-title">
        <h2 class="h1">Parenting Pod</h2>
    </div>
    <div class="case-grid">
        ...
        <div class="case-study">
            <img src="Images\Screenshot 2024-07-08 115129.png" class="case-img" alt="Forager app project">
        </div>
        <div class="case-study">
            <img src="Images\Screenshot 2024-07-08 115046.png" class="case-img" alt="Forager app project">
        </div>

        <div class="case-study">
            <h3 class="h2">The Problem</h3>
