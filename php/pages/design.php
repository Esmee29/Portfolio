<section id="design-projects" class="projects">
    <div class="index-title">
        <h2 class="h1">Design Projects</h2>
    </div>
    ...
    <div class="project-grid">
        ...
        <div class="card">
            <img src="Images\Fulcher_Esmee_H.jpg" class="image-card-app" alt="P.O.W. Story project">
            <div class="card__content">
